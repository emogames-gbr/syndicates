...
{
	$menuepunkte = array( "ablage" => "Ablage", "bearbeitung" => "in Bearb.", "history" => "History");
	...
	foreach ($menuepunkte as $bezeichner => $name) {
		$linkausgabe[] = ($view == $bezeichner ? "<b><u>$name</u></b>":"<a href=index.php?view=$bezeichner class=ver11s target=case_ablage>$name</a>");
	}
