	...
	[
		{
			...
			setUp: function(){
				...
				for(var i = 0 ; i < partLocaleList.length; i ++){
					dojo.requireLocalization("dojo.cldr","currency",partLocaleList[i], "it,en-au,ko,zh,en-ca,es,ja,en-us,zh-tw,de,fr,pt,ROOT,en");
					dojo.requireLocalization("dojo.cldr","number",partLocaleList[i], "ROOT,it,en-au,ko,zh,es,zh-cn,de-de,ja,en-us,zh-tw,en-gb,ko-kr,de,ja-jp,fr,pt,es-es,en");
				}
			},
			runTest: function(t){
