...
$id = 772;
	...
	$disapproved_pfad_absolut = PUB."/admin/konzernimages_disapproved";
	$disapproved_pfad_relativ = WWWPUB."admin/konzernimages_disapproved";
...
elseif ($mode == "showall")	{
	...
	$ausgabe .= "<center><a href=$self?action=vki>zurück</a></center>
				<br><br>
	...
	foreach ($images as $ky => $vl)	{
		...
		$ausgabe .= "$pre<td align=center valign=middle width=110 height=140><a href=$self?action=vki&mode=single&mode2=showall&konzernid=$ky><img src=$ki_pfad_relativ/konzern_".$ky.".".$vl[image]." border=0 title=\"<".$vl[syndicate]."><".$ky."> - Syndikat ".$vl[rid]."\"></a></td>$after";
		$zaehler++;
	}
	$ausgabe .= "</table>
				<br><br>
...
elseif ($mode == "pap")	{ # Pic After Pic
	...
	$ausgabe .= "<center><a href=$self>zurück</a></center>
				<br><br><br><br><br><br><a href=$self?action=vki&mode=pap>Pics After Pics (APPROVE MODE)</a><br><br><a href=$self?action=vki&mode=showall>Showall (FUN MODE)</a><br><br><br><br><br><br>
