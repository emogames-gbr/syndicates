			...
			$ausgabe .= "<tr><td colspan=2><hr></td></tr>
				...
				<tr>
					<td colspan=2 align=center>
						<a href=$self?action=idswitch&ia=directlogin&target=$ustatss[Konzernid] target=_blank>Direktlogin</a>
					</td>
				</tr>
				<tr>
					<td colspan=2 align=center>
						<a href=\"$self?action=traceuser&ia=trace&konid=$ustatss[Konzernid]\" target=_blank>History</a>
					</td>
				</tr>
			";
		}
...
$ausgabe.="
	<form action=$self>
		...
		Konzernid: <input name=konzernid><br>
		Username:<input name=koinsname><br>
		Konzernname:<input name=konname><br>
		<input type=hidden name=ia value=calc>
		<input type=\"hidden\" name=action value=idswitch>
		<input type=submit><br><br>
		Nur ein Datum angeben!
	</form>
	<br>
	<a href=\"document.history.back()\">Zurück</a>
";
